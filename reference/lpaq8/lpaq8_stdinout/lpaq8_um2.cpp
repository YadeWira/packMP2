...
//
//lpaq8-um2: optimized for unpackmp2 um2 data
//- Word model replaced with stride context (cross-frame correlation)
//- Disabled text-specific lowercase folding
...
#define upd7(m0,m1,m2,m3,m4,m5) \
  cp_update(m0,m1,m2,m3,m4,m5)		\
    ...
    upd7_cp				\
    /* word model disabled for binary/um2 data (no [A-Za-z] text) */ \
    cp[5]=t2a.get1(0);	/* neutral prediction, skips word hash building */ \
    c0=1;		\
    bcount=7;		\
    mm.upd();		\
    }
...
#endif
    mm(MEM*2), x1(0), x2(0xffffffff), x(0), p(2048) {
